...
print("Has Pressed value:"+haspressed);		
...
GUI.skin = mygui;
	...
	/*	if (GUI.Button(Rect((Screen.width/2)-220,(Screen.height/2)-450,170,250),"Bonus_round")){
		...
		if (GUI.Button(Rect((Screen.width/2)-170,(Screen.height/2)+70,360,140),btnTexture1)){
			Application.Quit();
			}
		
		if(GUI.Button(Rect((Screen.width/2)-170,(Screen.height/2)+240,360,140),btnTexture2)){
